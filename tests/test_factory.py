...
@pytest.mark.parametrize("raw,expected", [
    ("1", NacosClientV1), ("1.x", NacosClientV1), ("v1", NacosClientV1), ("v1.x", NacosClientV1),
    ("2", NacosClientV2), ("2.x", NacosClientV2), ("v2", NacosClientV2), ("v2.x", NacosClientV2),
    ("3", NacosClientV3), ("3.x", NacosClientV3), ("v3", NacosClientV3), ("v3.x", NacosClientV3),
])
